...
<div class="container-fluid">
                ...
                <table class="table table-sm table-borderless">
                    <tr>
                        <td class="font-weight-bold">
                            ...
                            <a href="<?= base_url('anggota/pengawasan/') . $urlx; ?>" class="btn btn-danger"> Reset</a>
                        </td>
                        <td>
                        ...
                        <div class="col-lg-12 text-uppercase font-weight-bold mb-3 ml-3">
                            ...
                            <table class="table-sm table-borderless" width="45%" align="left">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><?php
                                        $totalluasharian = $this->report->getPengawasanTotLuasTgl($lokasi['id_petak'], $tgl, $IdRes[5]);
                                ...
                                <table class="table table-bordered table-hover table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($bahan as $value) {
                                            $nilai = $this->report->getBahanProgresTgl($lokasi['id_petak'], $value['id_spkbahan'], $tgl, $IdRes[5]);
                                            $ket = $this->report->getBahanKetTgl($lokasi['id_petak'], $value['id_spkbahan'], $tgl, $IdRes[5]);
                                        ?>
                                            <tr>
                                                                ...
                                                                <div class="modal-body scrol">
                                                                    <div class="col-sm-12 m-0 p-0" style="min-width: 999px;">
                                                                        <table class="table-sm table-striped table-hover" width="100%">
                                                                            ...
                                                                            <?php
                                                                            $ni = 1;
                                                                            $sql = $this->db->get_where('harianbahan', ['id_spkbahan' => $value['id_spkbahan'], 'id_petak' => $value['id_petak'], 'tgl' => $tgl, 'id_user' => $IdRes[5]])->result_array();
                                                                            foreach ($sql as $val) { ?>
                                                                                <tr>
                                                                                    <td><?= $ni++; ?></td>
                                                                                    <td><?= $val['tgl']; ?></td>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        ...
                                                                                        ?>
                                                                                            <a class="btn btn-sm btn-info font-weight-bold" onclick="return confirm('Proses Approval pengawasan?')" href="<?= base_url('anggota/approve/') . $aprvBahan . "/" . $val['id_harianbahan'] . "/" . $urlx; ?>">
                                                                                                Approve
                                                                                            </a>
                                                                                            <hr class="m-1">
                                                                                            <a class="btn btn-sm btn-danger font-weight-bold" onclick="return confirm('Yakin akan me Reject Pengawasan ini? Reject akan menghapus dari daftar pengawasan harian?')" href="<?= base_url('anggota/reject/') . $aprvBahan . "/" . $val['id_harianbahan'] . "/"  . $urlx; ?>">
                                                                                                Reject
                                                                                            </a>
                                                                                        <?php
                                                                                        }
                                        ...
                                        foreach ($kategori as $kat) {
                                            $realisasi = $this->report->getRealisasiBibitnya($kat['id_spkbibit'], $IdRes[5]);
                                        ?>
                                            <tr>
                                            ...
                                            foreach ($bibit as $valueBibit) {
                                                $progresbibit = $this->report->getBibitProgresTgl($valueBibit['id_bibit'], $lokasi['id_petak'], $tgl, $IdRes[5]);
                                                $harianbibit = $this->db->get_where('harianbibit', ['id_bibit' => $valueBibit['id_bibit'], 'id_petak' => $lokasi['id_petak'], 'tgl' => $tgl, 'id_user' => $IdRes[5]])->result_array();
                                            ?>
                                                <tr>
                                                    <td></td>
                                                                                ...
                                                                                foreach ($harianbibit as $val) { ?>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-center">
                                                                                            ...
                                                                                            ?>
                                                                                                <a class="btn btn-sm btn-info font-weight-bold" onclick="return confirm('Proses Approval pengawasan?')" href="<?= base_url('anggota/approve/') . $aprvBibit . "/" . $val['id_harianbibit'] . "/" . $urlx; ?>">
                                                                                                    Approve
                                                                                                </a>
                                                                                                <hr class="m-1">
                                                                                                <a class="btn btn-sm btn-danger font-weight-bold" onclick="return confirm('Yakin akan me Reject Pengawasan ini? Reject akan menghapus dari daftar pengawasan harian?')" href="<?= base_url('anggota/reject/') . $aprvBibit . "/" . $val['id_harianbibit'] . "/"  . $urlx; ?>">
                                                                                                    Reject
                                                                                                </a>
                                                                                            <?php
                                                                                            }
                                        ...
                                        foreach ($lapangan as $valueLap) {
                                            $progreslapangan = $this->report->getLapanganProgresTgl($lokasi['id_petak'], $valueLap['id_spklapangan'], $tgl, $IdRes[5]);
                                            $harianlapangan = $this->db->get_where('harianlapangan', ['id_spklapangan' => $valueLap['id_spklapangan'], 'id_petak' => $lokasi['id_petak'], 'tgl' => $tgl, 'id_user' => $IdRes[5]])->result_array();
                                        ?>
                                            <tr>
                                                                            ...
                                                                            foreach ($harianlapangan as $val) { ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        ...
                                                                                        ?>
                                                                                            <a class="btn btn-sm btn-info font-weight-bold" onclick="return confirm('Proses Approval pengawasan?')" href="<?= base_url('anggota/approve/') . $aprvLapangan . "/" . $val['id_harianlapangan'] . "/" . $urlx; ?>">
                                                                                                Approve
                                                                                            </a>
                                                                                            <hr class="m-1">
                                                                                            <a class="btn btn-sm btn-danger font-weight-bold" onclick="return confirm('Yakin akan me Reject Pengawasan ini? Reject akan menghapus dari daftar pengawasan harian?')" href="<?= base_url('anggota/reject/') . $aprvLapangan . "/" . $val['id_harianlapangan'] . "/"  . $urlx; ?>">
                                                                                                Reject
                                                                                            </a>
                                                                                        <?php
                                                                                        }
    ...
    ?>
        <div class="card shadow mb-4">
            <a href="#reportHarian" title="Klik untuk memperkecil dan memperbesar" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="reportHarian">
                <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-list"></i> Detail Pengawasan Harian | Kab. <?= $lokasi['nm_kabupaten']; ?> | Kec. <?= $lokasi['nm_kecamatan']; ?> | Desa <?= $lokasi['nm_desa']; ?> | <?= $lokasi['nm_blok']; ?> | <?= $lokasi['nm_petak']; ?> | <?= $pl['nm_user']; ?></h6>
            </a>
                            ...
                            <div class="col-lg-12 text-uppercase font-weight-bold mb-3 ml-3">
                                ...
                                <table class="table-sm table-borderless" width="45%" align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><?php
                                            $totalluasharian = $this->report->getPengawasanTotLuas($lokasi['id_petak'], $IdRes[5]);
                                            $total = $totalluasharian['nilaibahan'] + $totalluasharian['nilailapangan'] + $totalluasharian['nilaibibit'];
                                            ?>
                                            <?= $total; ?> Ha
                                        </td>
                                ...
                                <small>
                                    <table class="table table-bordered table-hover table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            $bahan = $this->report->getBahan($lokasi['id_petak']);
                                            foreach ($bahan as $value) {
                                                $nilai = $this->report->getBahanProgres($lokasi['id_petak'], $value['id_spkbahan'], $IdRes[5]);
                                                $ket = $this->report->getBahanKet($lokasi['id_petak'], $value['id_spkbahan'], $IdRes[5]);
                                                                    ...
                                                                    <div class="modal-body scrol">
                                                                        <div class="col-sm-12 m-0 p-0" style="min-width: 999px;">
                                                                            <table class="table-sm table-striped table-hover" width="100%">
                                                                                ...
                                                                                error_reporting(0);
                                                                                $ni = 1;
                                                                                $sql = $this->db->get_where('harianbahan', ['id_spkbahan' => $value['id_spkbahan'], 'id_petak' => $value['id_petak'], 'id_user' => $IdRes[5]])->result_array();
                                                                                foreach ($sql as $val) { ?>
                                                                                    <tr>
                                                                                        <td><?= $ni++; ?></td>
                                                                                        <td><?= $val['tgl']; ?></td>
                                            ...
                                            ?>
                                                ...
                                                $bibit = $this->report->getBibit($kat['id_spkbibit']);
                                                foreach ($bibit as $valueBibit) {
                                                    $progresbibit = $this->report->getBibitProgres($valueBibit['id_bibit'], $lokasi['id_petak'], $IdRes[5]);
                                                    $harianbibit = $this->db->get_where('harianbibit', ['id_bibit' => $valueBibit['id_bibit'], 'id_petak' => $lokasi['id_petak'], 'id_user' => $IdRes[5]])->result_array();
                                            ...
                                            $lapangan = $this->report->getLapangan($lokasi['id_petak']);
                                            foreach ($lapangan as $valueLap) {
                                                $progreslapangan = $this->report->getLapanganProgres($lokasi['id_petak'], $valueLap['id_spklapangan'], $IdRes[5]);
                                                $harianlapangan = $this->db->get_where('harianlapangan', ['id_spklapangan' => $valueLap['id_spklapangan'], 'id_petak' => $lokasi['id_petak'], 'id_user' => $IdRes[5]])->result_array();
