            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <a href="<?= base_url('inputsa/harianbibitpertama'); ?>" title="Go">
                        ...
                        <div class="col-auto">
                            <a href="<?= base_url('inputsa/harianbibitpertama'); ?>" title="Go"><i class="fas fa-chevron-circle-right fa-3x  text-success"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <a href="<?= base_url('inputsa/harianbahan'); ?>" title="Go">
                        ...
                        <div class="col-auto">
                            <a href="<?= base_url('inputsa/harianbahan'); ?>" title="Go"><i class="fas fa-chevron-circle-right fa-3x text-info"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <a href="<?= base_url('inputsa/harianbibit'); ?>" title="Go">
                                <div class="text-x font-weight-bold text-success text-uppercase mb-1">Pengawasan Harian</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Pengadaan Bibit (Tahap II)</div>
                            </a>
                        </div>
                        <div class="col-auto">
                            <a href="<?= base_url('inputsa/harianbibit'); ?>" title="Go"><i class="fas fa-chevron-circle-right fa-3x  text-success"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <a href="<?= base_url('inputsa/harianlapangan'); ?>" title="Go">
                        ...
                        <div class="col-auto">
                            <a href="<?= base_url('inputsa/harianlapangan'); ?>" title="Go"><i class="fas fa-chevron-circle-right fa-3x text-danger"></i></a>
                        </div>
                    </div>
                </div>
            </div>
