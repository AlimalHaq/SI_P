<?php
$realisasi = $this->det->LoadHarianRealisasi($details['id_petak']);
$tglbahan = $this->det->LoadKueriHarianTglBahan($details['id_petak']);
$tglbibit = $this->det->LoadKueriHarianTglBibitNotin($details['id_petak']);
$tgllapangan = $this->det->LoadKueriHarianTglLapangan($details['id_petak']);
?>
<div class="row">
                            ...
                            datasets: [{
                                ...
                                data: [
                                    ...
                                    for ($xq = 0; $xq < $jumlahq; $xq++) {
                                        $nilaix = $this->det->LoadKueriHarianTglNilai($details['id_petak'], $angkaq[$xq]); //petak dan tanggalnya
                                        echo $nilaix['nilai'] . ',';
